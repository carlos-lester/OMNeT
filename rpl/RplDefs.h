...
#define DEFAULT_DIO_INTERVAL_MIN 0x03 // original 0x03
#define DEFAULT_DIO_REDUNDANCY_CONST 0x10   //original 0x03, changed 13-05-2022, but in RFC 6550 is = 10
...
enum RPL_SELF_MSG {
    ...
    DAO_ACK_TIMEOUT,
    RPL_START,
    METRIC_TIMER      //added by CL 2022-02-22
};
